...
_routes = [
    RedirectRoute('/admin/', users.AdminUserListHandler, name='admin-users-geochart', strict_slash=True),
    ...
    RedirectRoute('/admin/groups/add/', groups.AdminGroupEditHandler, name='admin-group-add', strict_slash=True, handler_method='edit'),
    RedirectRoute('/admin/groups/<group_id>/', groups.AdminGroupEditHandler, name='admin-group-edit', strict_slash=True, handler_method='edit'),

    RedirectRoute('/admin/groups/', groups.AdminGroupListHandler, name='admin-groups-list', strict_slash=True),
